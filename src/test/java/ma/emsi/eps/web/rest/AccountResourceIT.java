package ma.emsi.eps.web.rest;

import ma.emsi.eps.EvaluationSoutenancesApp;
import ma.emsi.eps.config.Constants;
import ma.emsi.eps.domain.Authority;
import ma.emsi.eps.domain.PersistentToken;
import ma.emsi.eps.domain.User;
import ma.emsi.eps.repository.AuthorityRepository;
import ma.emsi.eps.repository.PersistentTokenRepository;
import ma.emsi.eps.repository.UserRepository;
import ma.emsi.eps.security.AuthoritiesConstants;
import ma.emsi.eps.service.MailService;
import ma.emsi.eps.service.UserService;
import ma.emsi.eps.service.dto.PasswordChangeDTO;
import ma.emsi.eps.service.dto.UserDTO;
import ma.emsi.eps.web.rest.errors.ExceptionTranslator;
import ma.emsi.eps.web.rest.vm.KeyAndPasswordVM;
import ma.emsi.eps.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = EvaluationSoutenancesApp.class)

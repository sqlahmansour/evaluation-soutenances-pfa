package ma.emsi.eps.repository;

import ma.emsi.eps.EvaluationSoutenancesApp;
import ma.emsi.eps.config.Constants;
import ma.emsi.eps.config.audit.AuditEventConverter;
import ma.emsi.eps.domain.PersistentAuditEvent;
...
import static ma.emsi.eps.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
